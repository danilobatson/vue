...
<!-- Header -->
  ...
  <section class="mb-8 py-20 text-white text-center relative">
    ...
    <img class="relative block mx-auto mt-5 -mb-20 w-auto max-w-full" alt=""
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <form>
            ...
            <!-- Password -->
            <div class="mb-3">
              <label for="password" class="inline-block mb-2">Email
          ...
          <form>
            ...
            <label for="name" class="inline-block mb-2">Email
            ...
            <div class="mb-3">
              ...
              <input id="age" type="number"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded" /></label>
            </div>
            <!-- Password -->
            <div class="mb-3">
            ...
            <!-- Confirm Password -->
            <div class="mb-3">
              <label for="confirm-password" class="inline-block mb-2">Confirm Password
            ...
            <!-- TOS -->
            <div class="mb-3 pl-6">
              <label for="service" class="inline-block">Accept terms of service
              <input id="service" type="checkbox" class="w-4 h-4 float-left -ml-6 mt-1 rounded" />
              </label>
            </div>
            <button type="submit"
              class="block w-full bg-purple-600 text-white py-1.5 px-3 rounded transition
